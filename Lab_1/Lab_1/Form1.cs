...
namespace Lab_1
{
    public partial class Form1 : Form
    {
        ...
        private void grid(Graphics g,int size)
        {
            
            int numOfCells = pictureBox1.Width/pixelSize;
            int numOfCells2 = pictureBox1.Height / pixelSize;
            ...
            for (int x = 0; x < numOfCells2; ++x)
            {
                g.DrawLine(p, x * cellSize, 0, x * cellSize, numOfCells2 * cellSize);
            }
